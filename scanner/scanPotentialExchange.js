...
(async () => {
  const url = process.argv[2] || 'https://qa.bridgeconnect.uk/potential-exchange/';
  ...
  try {
    ...
    await page.screenshot({
      path: path.join(shotDir, 'PotentialExchange-page.png'),
      fullPage: true
    });

    // 5. DOM snapshot (generic PotentialExchange-page scan)
    ...
    fs.writeFileSync(
      path.join(domDir, 'PotentialExchange-page.json'),
