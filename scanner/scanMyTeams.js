...
(async () => {
  const url = process.argv[2] || 'https://qa.bridgeconnect.uk/my-teams/';
  ...
  try {
    ...
    await page.screenshot({
      path: path.join(shotDir, 'MyTeams-page.png'),
      fullPage: true
    });

    // 5. DOM snapshot (generic MyTeams-page scan)
    ...
    fs.writeFileSync(
      path.join(domDir, 'MyTeams-page.json'),
