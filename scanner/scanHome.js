...
(async () => {
  const url = process.argv[2] || 'https://qa.bridgeconnect.uk/ha-home';
  ...
  try {
    ...
    await page.screenshot({
      path: path.join(shotDir, 'haHome-page.png'),
      fullPage: true
    });

    // 5. DOM snapshot (generic haHome-page scan)
    ...
    fs.writeFileSync(
      path.join(domDir, 'haHome-page.json'),
