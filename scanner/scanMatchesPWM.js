...
(async () => {
  const url = process.argv[2] || 'https://qa.bridgeconnect.uk/ha-matches/properties_with_matches';
  ...
  try {
    ...
    await page.screenshot({
      path: path.join(shotDir, 'MatchesPWM-page.png'),
      fullPage: true
    });

    // 5. DOM snapshot (generic MatchesPWM-page scan)
    ...
    fs.writeFileSync(
      path.join(domDir, 'MatchesPWM-page.json'),
