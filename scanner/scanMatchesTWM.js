...
(async () => {
  const url = process.argv[2] || 'https://qa.bridgeconnect.uk/ha-matches/tenants_with_matches';
  ...
  try {
    ...
    await page.screenshot({
      path: path.join(shotDir, 'MatchesTWM-page.png'),
      fullPage: true
    });

    // 5. DOM snapshot (generic MatchesTWM-page scan)
    ...
    fs.writeFileSync(
      path.join(domDir, 'MatchesTWM-page.json'),
