...
(async () => {
  const url = process.argv[2] || 'https://qa.bridgeconnect.uk/ha-properties/1/25/undefined/undefined/undefined/';
  ...
  try {
    ...
    await page.screenshot({
      path: path.join(shotDir, 'Properties-page.png'),
      fullPage: true
    });

    // 5. DOM snapshot (generic Properties-page scan)
    ...
    fs.writeFileSync(
      path.join(domDir, 'Properties-page.json'),
